#!/usr/bin/env node
/**
 * One-off: re-host the Oracle Medical Centre image in the
...
const buf = readFileSync("/var/folders/7d/lsp5f20n7vj9_nj5bt8hkjrm0000gn/T/opencode/oracle-medical-centre.jpg");
const filename = "oracle-medical-centre.jpg";
...
const res = await client.query(
  ...
  [publicUrl, "oracle-medical-centre-laboratory-assistant"]
);
