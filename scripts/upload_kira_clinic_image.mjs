#!/usr/bin/env node
/**
 * One-off: re-host the Kira Medical Clinic poster image in the
...
const buf = readFileSync(`${process.env.HOME}/Downloads/medical.jpeg`);
const filename = "kira-medical-clinic-hiring.jpg";
...
const res = await client.query(
  `update public.posts set image_url = $1 where organization = 'Medical Clinic Kira'`,
  [publicUrl]
);
