#!/usr/bin/env node
/**
 * One-off: re-host the Friends Medicines Clinic poster image in the
...
const buf = readFileSync(`${process.env.HOME}/Downloads/friends.jpeg`);
const filename = "enrolled-nurse-friends-medicines-clinic.jpg";
...
const res = await client.query(
  `update public.posts set image_url = $1 where organization = 'Friends Medicines Clinic'`,
  [publicUrl]
);
