#!/usr/bin/env node
/**
 * One-off: re-host the NovaCare Medical Hub poster image in the
...
const buf = readFileSync(`${process.env.HOME}/Downloads/nova.jpeg`);
const filename = "medical-officer-novacare-medical-hub.jpg";
...
const res = await client.query(
  `update public.posts set image_url = $1 where organization = 'NovaCare Medical Hub'`,
  [publicUrl]
);
