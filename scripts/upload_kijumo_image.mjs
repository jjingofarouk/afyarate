#!/usr/bin/env node
/**
 * One-off: re-host the Kijumo Community Health Link poster image in the
...
const buf = readFileSync(`${process.env.HOME}/Downloads/kijumo.jpeg`);
const filename = "kijumo-community-health-link.jpg";
...
const res = await client.query(
  `update public.posts set image_url = $1 where organization = 'Kijumo Community Health Link'`,
  [publicUrl]
);
