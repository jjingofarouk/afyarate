#!/usr/bin/env node
/**
 * One-off: re-host the Kyenjojo Medical Centre poster image in the
...
const buf = readFileSync(`${process.env.HOME}/Downloads/kyenjojo medical center.jpeg`);
const filename = "enrolled-midwife-kyenjojo-medical-centre.jpg";
...
const res = await client.query(
  `update public.posts set image_url = $1 where organization = 'Kyenjojo Medical Centre'`,
  [publicUrl]
);
