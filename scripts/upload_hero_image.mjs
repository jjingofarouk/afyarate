#!/usr/bin/env node
/**
 * Download the homepage hero photo (currently hotlinked from iStock) and
 * re-host it in the Supabase `post-images` bucket, then print the public URL.
 */
...
const SRC =
  "https://media.istockphoto.com/id/2156017445/photo/pediatric-checkup-for-smiling-boy-with-mother-and-doctor.webp?a=1&b=1&s=612x612&w=0&k=20&c=sQDaqjnI8xIG2k5xPD6hfVZhs872KhwoTZF-k1mCJ48=";
const UA =
...
const filename = `home-hero-pediatric-checkup.${ext}`;
