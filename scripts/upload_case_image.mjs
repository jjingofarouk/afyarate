#!/usr/bin/env node
/**
 * One-off: re-host the Case Clinic dentist poster image in the
...
const buf = readFileSync(`${process.env.HOME}/Downloads/case.jpeg`);
const filename = "dentists-case-clinic.jpg";
...
const res = await client.query(
  `update public.posts set image_url = $1 where organization = 'Case Clinic'`,
  [publicUrl]
);
