#!/usr/bin/env node
/**
 * One-off: re-host the Mushanga Health Centre III image in the
 * Supabase `post-images` bucket and set image_url on its job listing.
 */
...
const buf = readFileSync("/var/folders/7d/lsp5f20n7vj9_nj5bt8hkjrm0000gn/T/opencode/mushanga-hc.jpg");
const filename = "mushanga-health-centre-iii.jpg";
...
const res = await client.query(
  `update public.posts set image_url = $1 where slug = $2`,
  [publicUrl, "mushanga-health-centre-iii-laboratory-technician"]
);
