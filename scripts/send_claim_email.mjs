/**
 * Medical Opportunities Hub Uganda, one-off claim-profile email sender.
 * Usage:
...
const SUBJECT = "Your Medical Opportunities Hub Uganda verified profile is live - complete payment within 48hrs";
      ...
      <table width="100%" cellpadding="0" cellspacing="0" border="0" style="max-width:640px;">
        ...
        <tr><td style="background:#ffffff;padding:32px 24px 24px;">
          ...
          <p style="margin:0 0 14px;font-size:15px;color:#374151;line-height:1.7;">
            Good news, your claimed profile on Medical Opportunities Hub Uganda is now live. It shows your
          ...
          <p style="margin:20px 0 0;font-size:15px;color:#374151;line-height:1.7;">
            Thank you for joining Medical Opportunities Hub Uganda.<br>
            Best regards,<br>
            <strong>Medical Opportunities Hub Uganda Team</strong>
          </p>
        </td></tr>
...
Good news, your claimed profile on Medical Opportunities Hub Uganda is now live:
${PROFILE_URL}
...
Thank you for joining Medical Opportunities Hub Uganda.
Best regards,
Medical Opportunities Hub Uganda Team`;
