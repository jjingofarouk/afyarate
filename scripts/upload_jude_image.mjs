#!/usr/bin/env node
/**
 * Upload the St Jude Medical and Surgical Center image (from ~/Downloads/jude.jpeg)
 * to the Supabase `post-images` bucket and point the post JSON at the new URL.
 */
...
const SRC = process.env.HOME + "/Downloads/jude.jpeg";
const buf = readFileSync(SRC);
const mime = "image/jpeg";
console.log(`Read ${buf.length} bytes (${mime}) from ${SRC}`);

const filename = "enrolled-midwife-st-jude-medical-and-surgical-center-gayaza.jpg";
...
const file = "data/posts/enrolled-midwife-st-jude-medical-and-surgical-center-gayaza.json";
