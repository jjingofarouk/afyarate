#!/usr/bin/env node
/**
 * One-off: re-host the Arua School of Comprehensive Nursing image in the
...
const buf = readFileSync("/var/folders/7d/lsp5f20n7vj9_nj5bt8hkjrm0000gn/T/opencode/arua-nursing.jpg");
const filename = "arua-school-comprehensive-nursing.jpg";
...
const res = await client.query(
  `update public.posts set image_url = $1 where organization ilike 'Arua School of Comprehensive Nursing%'`,
  [publicUrl]
);
