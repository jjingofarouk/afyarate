...
export const metadata: Metadata = {
  ...
  description:
    "Claim your health worker profile on Rate My Musawo: a verified licence badge, your contacts and workplace, visible to patients. One payment of UGX 5,000, valid forever.",
