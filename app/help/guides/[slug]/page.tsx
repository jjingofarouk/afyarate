...
import { HELP_GUIDES, getHelpGuide } from "@/data/help-guides";
    ...
    "@graph": [
      {
        ...
        mainEntityOfPage: `${SITE_URL}/help/guides/${guide.slug}`,
      },
      {
        "@type": "BreadcrumbList",
        itemListElement: [
          ...
          { "@type": "ListItem", position: 3, name: "Guides", item: `${SITE_URL}/help/guides` },
          { "@type": "ListItem", position: 4, name: guide.title, item: `${SITE_URL}/help/guides/${guide.slug}` },
        ],
      },
    ],
  };
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <nav className="text-xs text-slate-400 dark:text-slate-500">
        ...
        <Link href="/help/guides" className="hover:text-emerald-700 dark:hover:text-emerald-400">
          Guides
        </Link>
        <span className="mx-1.5">/</span>
