...
export const metadata: Metadata = {
  title: "About",
  description:
    "Rate Musawo was built by Dr. Farouk Jjingo, a Ugandan doctor. Verified practitioners, patient ratings, health jobs and facilities across Uganda.",
...
const personJsonLd = {
  ...
  "@type": "Person",
  name: FOUNDER_NAME,
  jobTitle: "Founder, Rate Musawo",
  description:
    "Ugandan medical doctor building Rate Musawo: verified practitioner profiles, patient ratings, and health jobs across Uganda.",
  image: `${SITE_URL}/founder.jpg`,
  url: FOUNDER_LINKEDIN,
  sameAs: [FOUNDER_LINKEDIN],
  worksFor: { "@type": "Organization", name: "Rate Musawo", url: SITE_URL },
};
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12">
      ...
      <div className="mt-6 space-y-5 text-sm leading-relaxed text-slate-700 dark:text-slate-300">
        <p>
          <strong>Rate Musawo</strong> (Luganda for <em>health worker</em>) is the
          ...
          <div className="flex flex-col items-center gap-5 text-center sm:flex-row sm:text-left">
            ...
            <div className="min-w-0 flex-1">
              ...
              <p className="mt-2 text-sm leading-relaxed text-slate-600 dark:text-slate-400">
                Rate Musawo is a small, growing project I built and still maintain
        ...
        <p>
          Rate Musawo is free for patients and has no ads. It is kept alive by
        ...
        <div className="flex flex-wrap gap-3">
          <a
            href={`mailto:${DEVELOPER_EMAIL}?subject=${encodeURIComponent("Funding Rate Musawo")}`}
        ...
        <p>
          ...
          lag the regulator&apos;s records. Rate Musawo is not affiliated with any
