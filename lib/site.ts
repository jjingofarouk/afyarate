...
export const SITE_NAME = "Rate My Musawo";
...
// Direct dispatch + hiring line answered by the Rate My Musawo team. Shown on
...
export const HIRING_EMAIL_LINK = `mailto:${HIRING_EMAIL}?subject=${encodeURIComponent("Hiring health workers via Rate My Musawo")}`;
